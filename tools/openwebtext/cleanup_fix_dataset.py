...
def process_set(args, input_file, output_f_cleaned, output_f_filtered):
    ...
    num_docs = num_remove_512 = num_remove_java = num_remove_512_non_english = num_ftfy_fix_text = (
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input-files", nargs="*", required=True, default=None, help="Input json files that needs to be" " cleaned"
    )
    parser.add_argument(
        "--tasks",
        nargs="*",
