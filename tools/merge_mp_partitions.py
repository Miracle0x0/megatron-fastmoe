...
def main():
    ...
    set_global_variables(
        extra_args_provider=get_mp_merge_args,
        args_defaults={
    ...
    while True:
        try:
            ...
            print("     merged         type: {}, size: {}".format(merged_param.dtype, list(merged_param.size())))
            partitions_param = []
            ...
            # For parallel parameters, merge the values
                ...
                print(f"     parallel parameter merge with stride {stride} along " f"dimention {dim}")
    ...
    assert (
        args.num_layers % args.pipeline_model_parallel_size == 0
