...
class ICTBertModel(MegatronModule):
    ...
    def __init__(
        self, ict_head_size, num_tokentypes=1, parallel_output=True, only_query_model=False, only_block_model=False
    ):
        super(ICTBertModel, self).__init__()
        bert_kwargs = dict(ict_head_size=ict_head_size, num_tokentypes=num_tokentypes, parallel_output=parallel_output)
