...
class ParallelAttention(MegatronModule):
    ...
    def _checkpointed_attention_forward(self, query_layer, key_layer, value_layer, attention_mask):
        ...
        hidden_states = mpu.checkpoint(custom_forward, False, query_layer, key_layer, value_layer, attention_mask)
...
class ParallelTransformer(MegatronModule):
    ...
    def __init__(
        ...
        # Number of layers.
        self.num_layers = mpu.get_num_layers(args, args.model_type == ModelType.encoder_and_decoder)
