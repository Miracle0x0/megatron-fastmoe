...
def build_train_valid_test_datasets(
    data_prefix, data_impl, splits_string, train_valid_test_num_samples, seq_length, seed, skip_warmup
):
    ...
    if len(data_prefix) == 1:
        return _build_train_valid_test_datasets(
            data_prefix[0], data_impl, splits_string, train_valid_test_num_samples, seq_length, seed, skip_warmup
        )
...
def _build_train_valid_test_datasets(
    ...
    def build_dataset(index, name):
        ...
        if splits[index + 1] > splits[index]:
            ...
            dataset = GPTDataset(
                name, data_prefix, documents, indexed_dataset, train_valid_test_num_samples[index], seq_length, seed
            )
        return dataset
...
class GPTDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, name, data_prefix, documents, indexed_dataset, num_samples, seq_length, seed):
