...
def test_parallel_self_attention(tensor_model_parallel_size):
    ...
    rank_1, hideen_size_1, tensor_model_parallel_size_1, loss_1, attention_layer_1, identity_layer_1 = (
...
def parallel_transformer(
    tensor_model_parallel_size, num_att_heads_per_partition, hidden_size_per_att_head, batch_size, sequence_length
):
...
def test_parallel_transformer_layer(tensor_model_parallel_size):
    ...
    rank_1, hidden_size_1, tensor_model_parallel_size_1, loss_1, transformer_layer_1, identity_layer_1 = (
        parallel_transformer(1, num_att_heads_per_partition, hidden_size_per_att_head, batch_size, sequence_length)
    )
