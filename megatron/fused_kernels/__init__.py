...
def load(args):
    ...
    if args.gradient_accumulation_fusion:
        sources = [srcpath / "fused_weight_gradient_dense.cpp", srcpath / "fused_weight_gradient_dense.cu"]
        fused_dense_cuda = _cpp_extention_load_helper("fused_dense_cuda", sources, [])
