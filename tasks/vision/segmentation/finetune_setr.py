...
def segmentation():
    ...
    def model_provider(pre_process=True, post_process=True):
        ...
        return SetrSegmentationModel(num_classes=args.num_classes, pre_process=pre_process, post_process=post_process)
        ...
        with torch.no_grad():
            ...
            for _, batch in enumerate(dataloader):
                loss_dicts = forward_backward_func(
                    correct_answers_forward_step, batch, model, optimizer=None, timers=None, forward_only=True
                )
    ...
    def dump_output_data(data, iteration, writer):
        for output_tb, loss in data:
            ...
            writer.add_images("image-outputseg-realseg", output_tb, global_step=None, walltime=None, dataformats="NCHW")
