...
def orqa(Dataset):
    ...
    def cross_entropy_forward_step(batch, model):
        ...
        # Forward model.
        output_tensor = model(query_tokens, query_mask, query_types, context_tokens, context_mask, context_types)
    ...
    def train_valid_datasets_provider():
        ...
        train_dataset = Dataset("training", args.train_data, tokenizer, args.retriever_seq_length, evaluate=False)
        valid_dataset = Dataset("validation", args.valid_data, tokenizer, args.retriever_seq_length, evaluate=True)
