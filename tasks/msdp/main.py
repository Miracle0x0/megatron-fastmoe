...
def get_tasks_args(parser):
    ...
    group.add_argument("--sample-output-file", type=str, default=None, help="Output file got from --sample-input-file")
    ...
    group.add_argument("--api-prompt", default=False, action="store_true", help="setup model api for prompting")
