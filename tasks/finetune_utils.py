...
def _train(
    model, optimizer, opt_param_scheduler, forward_step, train_dataloader, valid_dataloader, end_of_epoch_callback
):
    """Train the model."""
    args = get_args()
    timers = get_timers()
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for iteration_, batch in enumerate(train_dataloader):
            ...
            if args.eval_interval and iteration % args.eval_interval == 0:
                ...
                evaluate_and_print_results(prefix, forward_step, valid_dataloader, model, iteration, None, False)
