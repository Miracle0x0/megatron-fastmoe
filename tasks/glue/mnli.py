    ...
    def process_samples_from_single_path(self, filename):
        ...
        with open(filename, "r") as f:
            for line in f:
                ...
                if first:
                    ...
                    if len(row) == 10:
                        ...
                        print_rank_0(
                            ...
                            "labels to {}".format(row[0].strip(), row[8].strip(), row[9].strip(), self.test_label)
                        )
                    else:
                        print_rank_0(
                            "    reading {} , {}, {}, and {} columns "
                            "...".format(row[0].strip(), row[8].strip(), row[9].strip(), row[-1].strip())
                        )
                    continue
                ...
                sample = {"text_a": text_a, "text_b": text_b, "label": LABELS[label], "uid": unique_id}
                total += 1
